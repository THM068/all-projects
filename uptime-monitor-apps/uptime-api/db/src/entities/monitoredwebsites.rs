...
pub async fn create(
    ...
    let record = sqlx::query!(
        "INSERT INTO monitored_websites (id,url,user_id,check_interval,latency_threshold,consecutive_failures_threshold,created_at,updated_at) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING id,url,user_id,check_interval,latency_threshold,consecutive_failures_threshold,created_at,updated_at",
        Uuid::new_v4(),
